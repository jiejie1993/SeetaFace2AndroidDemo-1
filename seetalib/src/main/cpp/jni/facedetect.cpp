...
#include <sstream>
#include <SeetaFace2/FaceDetector/FaceDetector.h>
#include <SeetaFace2/FaceLandmarker/FaceLandmarker.h>
...
Java_com_cvte_vslam_seetalib_seeta_FaceDetector_initFaceDetection(JNIEnv *env, jobject instance,
...
Java_com_cvte_vslam_seetalib_seeta_FaceDetector_applyFaceDetection(JNIEnv *env, jobject instance, jlong addr) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cvte_vslam_seetalib_seeta_FaceDetector_releaseFaceDetection(JNIEnv *env, jobject instance) {
    delete FD;
    delete FL;
