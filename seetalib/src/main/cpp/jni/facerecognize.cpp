...
Java_com_cvte_vslam_seetalib_seeta_FaceRecognizer_initNativeEngine(JNIEnv *env, jobject instance,
...
Java_com_cvte_vslam_seetalib_seeta_FaceRecognizer_nativeRegisterFace(JNIEnv *env, jobject instance, jobject faceList) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_cvte_vslam_seetalib_seeta_FaceRecognizer_nativeRecognition(JNIEnv *env, jobject instance, jlong addr) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cvte_vslam_seetalib_seeta_FaceRecognizer_releaseNativeEngine(JNIEnv *env, jobject instance) {
    if(NULL != FE) {
        delete FE;
    }
